...
import { User, UserBadges } from "uwucord.js";
          ...
          <Show when={props.user.badges & UserBadges.Translator}>
            <img
              use:floating={{
                tooltip: {
                  placement: "top",
                  content: t`Helped translate uwucord`,
                },
              }}
              src={badgeTranslator}
            />
